---
title: "Xaringa presentations"
subtitle: "⚔<br/>con xaringan"
author: "Raymond L. Tremblay"
institute: "ANALITICA Fundación"
date: "2021/09/09 (updated: `r Sys.Date()`)"
output:
...
[Un video sobre xarigan, presione aqui](https://www.youtube.com/watch?v=3n9nASHg9gc)
---
...
Instalar el paquete **xaringan** con este enlace [Github](https://github.com/yihui/xaringan):
...
Se recomienda que use [RStudio IDE](https://www.rstudio.com/products/rstudio/), pero no es obligatorio. 

- Crear un nuevo documento .Rmd `File -> New File -> R Markdown -> From Template -> Ninja Presentation`;<sup>1</sup>

--

- Presione el botón de `Knit` para compilar el documento;

--

- o usar [RStudio Addin](https://rstudio.github.io/rstudioaddins/)<sup>2</sup> "Infinite Moon Reader" para que los cambios aparezca automaticamente en la diapositiva a cada vez que haga que salva el documento. 

.footnote[
[1] 中文用户请看[这份教程](https://slides.yihui.org/xaringan/zh-CN.html)

[2] See [#2](https://github.com/yihui/xaringan/issues/2) vea este enlace si no ve el *template* o *addin* en RStudio.
]
...
# Vives solamente una vez!
---

Añadir una foto que esta salvado en un archivo en su computadora
...
Ya que Ud es un super presentador, no debería limitarse con *Hola Ninja*  Necesita entender dos otros asuntos  

1. El paquete [remark.js](https://remarkjs.com);

1. El paquete **xaringan**;

Basicamente **xaringan** utiliza la *chackra* de R Markdown (menos Pandoc) en **remark.js**. Las laminas están formateado con **remark.js** en el **web browser**, y los codigos **Markdown** necesarios por **remark.js** están generado por **R Markdown** cuando hace un **knitr**.

---

# remark.js

Puede encontrar una introduccióon a **remark.js** en [esta pagina](https://remarkjs.com). Deberia leer [remark.js Wiki](https://github.com/gnab/remark/wiki) por lo menos una vez para conocer como 

- crear (la sintaxis de Markdown <sup>*</sup> y la propriedades de las laminas);

- foformatear las laminas (e.g. alienar el texto);

- configurar la presentación;

- y como manipular la presentación (keyboard shortcuts).

Es importante comnocer **remark.js** antes de entender las opciones de **xaringan**.
...
# Contento de de cnocer *remark.js*!
...
Preeve que `xaringan::moon_reader` puede visualizarse como un documento RMarkdown, como un *wrapper* por **remark.js**, y lo podemos ver en la metada del YAML, e.g.
...
vea la página de ayuda con `?xaringan::moon_reader` para todas las alternativas disponible.

---

# remark.js vs xaringan

La diferencia entre **remark.js** (izquierda) y usando **xaringan** (derecha):
